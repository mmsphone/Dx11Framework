...
HRESULT Monster::Initialize(void* pArg)
{
    ...
    pTransform->SetState(STATE::POSITION, XMVectorSet(
        m_pEngineUtility->Random(0.f, 10.f),
        3.0f,
        m_pEngineUtility->Random(0.f, 10.f),
        1.f
    ));
...
void Monster::PriorityUpdate(_float fTimeDelta)
{
...
void Monster::LateUpdate(_float fTimeDelta)
{
...
Object* Monster::Clone(void* pArg)
{
