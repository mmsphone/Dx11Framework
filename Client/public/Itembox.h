...
class Itembox : public ObjectTemplate
{
    Itembox();
    Itembox(const Itembox& Prototype);
    virtual ~Itembox() = default;
...
private:
    ...
    void SetVisibleItemboxUI(_bool bVisible);
    _bool GiveGrenadeToPlayer();

    _float scaleOffset = 2.f;
