...
HRESULT GameScene::ReadyLayerCamera()
{
	...
	//
	//if (FAILED(m_pEngineUtility->AddObject(SCENE::GAMEPLAY, TEXT("FreeCam"), SCENE::GAMEPLAY, TEXT("Cam"), &Desc)))
	//	return E_FAIL;
	...
	//Desc.fRotationPerSec = XMConvertToRadians(120.0f);
	//
	//if (FAILED(m_pEngineUtility->AddObject(SCENE::GAMEPLAY, TEXT("FixedCam"), SCENE::LOGO, TEXT("Cam"), &Desc)))
	//	return E_FAIL;
	...
	if (FAILED(m_pEngineUtility->AddObject(SCENE::GAMEPLAY, TEXT("ChaseCam"), SCENE::GAMEPLAY, TEXT("Cam"), &Desc)))
		return E_FAIL;
