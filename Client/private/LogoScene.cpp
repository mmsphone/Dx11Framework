...
HRESULT LogoScene::ReadyUI()
{
	...
	for (auto& ui : UIs)
	{
		...
		else if (str == "setting_default")
		{
			u->SetVisible(true);
		}
		else if (str == "swarm_default")
		{
			u->SetVisible(true);
		}
		else if (str == "exit_default")
		{
			u->SetVisible(true);
		}
		else if (str == "messsage_default")
		{
			u->SetVisible(true);
		}
		...
		else if (str == "map_default")
		{
			u->SetVisible(true);
		}
		//on
		else if (str == "setting_on")
		{
			static_cast<UIImage*>(u)->SetBrightness(1.6f);
			static_cast<UIImage*>(u)->SetGamma(0.5f);
		}
		...
		else if (str == "exit")
		{
			...
			static_cast<UIButton*>(u)->AddLeftButtonFunction([]() {
		...
		else if (str == "solo")
		{
			...
			static_cast<UIButton*>(u)->AddLeftButtonFunction([this]() {
				m_next = true;
			});
		}
		else if (str == "top1")
		...
		//text
		else if (str == "room_text")
		{
			u->SetVisible(true);
		}
		else if (str == "solo_text")
		{
			u->SetVisible(true);
		}
		else if (str == "lobby_text")
		{
			u->SetVisible(true);
		}
		else if (str == "top1_text")
		{
			u->SetVisible(true);
		}
		else if (str == "top2_text")
		{
			u->SetVisible(true);
		}
		else if (str == "top3_text")
		{
			u->SetVisible(true);
		}
		else if (str == "top4_text")
		{
			u->SetVisible(true);
		}
	}
	m_pEngineUtility->GetUICount();
...
void LogoScene::Free()
{
	m_pEngineUtility->StopSound("BGM_lobby");
	__super::Free();
}
